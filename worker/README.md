...
- `live` คือเมมเบอร์ที่กำลังไลฟ์ใน iAM48 · `youtube` คือช่องที่กำลังถ่ายทอดสด
...
- **Worker เช็กให้ทั้งสองอย่าง** ทั้งไลฟ์ iAM48 และไลฟ์ YouTube ของ BNK48/CGM48 ฝั่ง YouTube อ่านจากหน้า `/live` ของช่องโดยตรง ไม่ใช้คีย์ API จึงไม่กินโควตา และเช็กบ่อยได้ (นาทีละครั้ง ใช้ร่วมกันทุกคน) GitHub Actions ยังทำงานเป็นตัวสำรองเหมือนเดิม
